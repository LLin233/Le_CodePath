...
public class RepoDbHelper {
    ...
    public static final String REPO_DESCRIPTION_COLUMN = "Description";
    public static final int REPO_DESCRIPTION_COLUMN_POSITION = 3;
    ...
    private static final String DATABASE_REPO_CREATE = "create table " + REPO_TABLE + " (" +
            ...
            REPO_DESCRIPTION_COLUMN + " text, " +
            REPO_OWNER_COLUMN + " text" +
            ")";


    // ----------------Repo HELPERS --------------------
    public long addRepo(String Id, String Name, String Description, String Owner) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(REPO_ID_COLUMN, Id);
        contentValues.put(REPO_NAME_COLUMN, Name);
        contentValues.put(REPO_DESCRIPTION_COLUMN, Description);
        contentValues.put(REPO_OWNER_COLUMN, Owner);
        return mDb.insert(REPO_TABLE, null, contentValues);
    }

    public long updateRepo(long rowIndex, String Id, String Name, String Description, String Owner) {
